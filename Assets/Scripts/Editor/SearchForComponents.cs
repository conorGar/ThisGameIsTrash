...
// Pulled from one of the many great examples here: https://forum.unity.com/threads/editor-want-to-check-all-prefabs-in-a-project-for-an-attached-monobehaviour.253149/
public class SearchForComponents : EditorWindow
{
    [MenuItem("TGIT/Search For Components")]
    static void Init()
    {
