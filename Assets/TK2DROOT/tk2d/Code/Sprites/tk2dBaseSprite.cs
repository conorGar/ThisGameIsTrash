...
public abstract class tk2dBaseSprite : MonoBehaviour, tk2dRuntime.ISpriteCollectionForceBuild
{
	...
	protected virtual void UpdateCollider()
	{
		...
		if (sprite.physicsEngine == tk2dSpriteDefinition.PhysicsEngine.Physics3D && dontCreateCollision == false) {
#if !STRIP_PHYSICS_3D
			if (sprite.colliderType == tk2dSpriteDefinition.ColliderType.Box && boxCollider == null)
			{
				...
				if (boxCollider == null && gameObject.GetComponent<BoxCollider2D>() == null)
				{
	...
	{
		tk2dSpriteDefinition sprite = collectionInst.spriteDefinitions[_spriteId];
		if (sprite.colliderType == tk2dSpriteDefinition.ColliderType.Unset || dontCreateCollision == true)
		{
