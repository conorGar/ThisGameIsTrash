...
namespace I2.TextAnimation
{
    ...
    public class SE_AnimSequence_Position : SE_AnimSequence
    {
        ...
        public eAnimBlendMode _AnimBlend_From = eAnimBlendMode.Offset;
        public eAnimBlendMode _AnimBlend_To = eAnimBlendMode.Offset;
        ...
        public override void Apply_Characters(TextAnimation se, SE_Animation anim, int sequenceIndex)
        {
            ...
            if (_AnimBlend_From == eAnimBlendMode.Replace)
            {
            ...
            if (_AnimBlend_To == eAnimBlendMode.Replace)
            {
            ...
            for (int iElement = mElementRangeStart; iElement < mElementRangeEnd; ++iElement)
            {
                ...
                var vFrom = (_AnimBlend_From == eAnimBlendMode.Offset) ? (currentValue + from) : from;
                var vTo = (_AnimBlend_To == eAnimBlendMode.Offset) ? (currentValue + to) : to;
